...
.forum-post .meta { padding: 0.5em 1em; border: 1px solid #b4c7e6; background: url(${h.static_uri('local', 'images/layout/th-background.png')}) left bottom repeat-x; border-top-left-radius: 0.5em; border-top-right-radius: 0.5em; }
